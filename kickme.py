...
class LeaveMod(loader.Module):
	...
	async def kickmecmd(self, message):
		...
		if not message.chat:
			await message.edit("<b>Йой это не группа</b>")
			return
		text = utils.get_args_raw(message)
		if not text:
		    GIF = ["https://i.gifer.com/1UEg.gif", "https://i.gifer.com/5Tp.gif", "https://i.gifer.com/Tia.gif",
		     "https://i.gifer.com/7wD7.gif", "https://i.gifer.com/fya2.gif"]
